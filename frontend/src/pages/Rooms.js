...
const Rooms = () => {
    ...
    const [roomForm, setRoomForm] = useState({ name: '', capacity: '', equipment: '', roomTypeId: '' });
    ...
    const applyFilters = () => {
        ...
        // Filtre par type
        if (filterType) {
            result = result.filter(room => room.room_type_id === parseInt(filterType));
        }
        ...
        <Layout>
            ...
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Gérez les salles de réunion</p>
                </div>
                {isAdmin && (
                    <button
            ...
            {filteredRooms.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredRooms.map((room) => (
                        <div key={room.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-200">
                            <div className="h-32 bg-gradient-to-br from-blue-500 to-indigo-600 relative">
                                ...
                                <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full">
                                    <span className="text-white text-sm font-medium">{room.capacity} pers.</span>
                                </div>
                                {room.type_name && (
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex items-center text-gray-500 text-sm mb-4">
                                    ...
                                    {room.description || 'Aucun équipement'}
                                </div>
                                {isAdmin && (
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Type de salle</label>
                                <select
